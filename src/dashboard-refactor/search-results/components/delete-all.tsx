...
export default function DeleteAll(prop: { onClick: () => void }) {
    return (
        <>
            <ButtonTooltip tooltipText="Delete all" position="bottom">
                <ActionBtn onClick={prop.onClick}>
                    <ActionIcon src={icons.trash} />
                </ActionBtn>
            </ButtonTooltip>
